...
Validation records: [Phase 3](docs/testing/phase-3-manual-smoke-test.md), [Phase 4](docs/testing/phase-4-manual-smoke-test.md), [Phase 5](docs/testing/phase-5-manual-smoke-test.md). Selector reference and re-verification snippet: [docs/testing/linkedin-selectors.md](docs/testing/linkedin-selectors.md).
