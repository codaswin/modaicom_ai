export type DiagnosticCode = 'FEED_ROOT_NOT_FOUND' | 'FEED_REGIME_UNKNOWN' | 'POST_ROOT_NOT_RECOGNIZED' | 'BODY_MARKER_NOT_FOUND' | 'COMPOSER_NOT_RECOGNIZED' | 'OWNERSHIP_AMBIGUOUS' | 'EXACT_ROOT_INVALID' | 'AUTHOR_NOT_FOUND' | 'POST_TEXT_NOT_FOUND' | 'RELAY_REJECTED' | 'COMMENT_REPLY_REGIME_UNSUPPORTED' | 'AMBIGUOUS_TARGET_COMMENT'
